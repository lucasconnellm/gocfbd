...
type AdvancedGameStatOffense struct {
	...
	PassingDowns *AdvancedGameStatOffenseStandardDowns `json:"passingDowns,omitempty"`
	RushingPlays *AdvancedGameStatOffenseRushingPlays `json:"rushingPlays,omitempty"`
	PassingPlays *AdvancedGameStatOffenseRushingPlays `json:"passingPlays,omitempty"`
}
